...
class test_gus_event(unittest.TestCase):    
        def test_event_init(self):
            ...
            new_event = Gus_event.objects.create(calendar = new_calendar, creator = new_user, event_name = "Mission 1", start_date = "2011-02-14 10:00", description = event_description, Group=new_group)
            new_event.save()
