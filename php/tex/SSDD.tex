...
The software being considered for development is referred to as Groups in a
University Setting (GUS).  The customers providing specifications for the PHP
team are the student groups at the University of Idaho.  The ultimate customers
or end users will be the students and student groups at the University of Idaho.
...
This document is intended to be used to help design and document GUS.
		\subsubsection{Document Scope}
This document includes the documentation necessary to program GUS -- including
UML diagrams, use-case descriptions, and a data dictionary.
		\subsubsection{Intended Audience for Document}
This document is intended for the developers (the PHP team), the team leader
(Dr. J), and any personnel performing maintenance on and updating GUS.  While the system will be used by university personnel, this document is
...
The purpose of the system under development is to provide a tool for the easy
administration and tracking of university-style groups including, but not
limited to clubs and sports teams, the system will also be designed to increase
student involvement by connecting and recognizing the involvement of users.
		\subsubsection{System and Software Scope/or Context}
GUS is a tool to connect students with groups that will meet their involvement
needs.  It is also a tool to help recruit and manage members of university
groups.
		\subsubsection{Intended Users for the System and Software}
The indended users of the system are the student groups of the University of
Idaho and University of Idaho students.
...
\end{enumerate}
	\subsection{Document Overview}
		\subsubsection{Section 2} of this document describes the system and software constraints
...
describes their concerns and mitigations to those concerns.
	\subsubsection{Section 3} of this document describes the system and software architecture from several
viewpoints, including, but not limited to,
the developers view and the users view.
	\subsubsection{Section 4} provides detailed design descriptions for every component defined in the
architectural view(s).
	\subsubsection{Sections 5} provides traceability
...
document.
	\subsubsection{Section 6} and beyond are appendices including original information and communications used to create this document.
...
GUS must meet the privacy requirements as they apply to both the
University of Idaho and social networking sites.  It should be
maintained in a secure office, away from prying eyes, flooding, and be
able to withstand frequent power outages in the case of wind storms.
		\subsubsection{System Requirement Constraints.}
GUS needs to be able to interface with any data source it needs
information from, which could be databases, web authentication servers,
and users.  It should be reliable with little maintainance, and keep
information on it secure.
...
through the options.  Basic computer use skills and a simple conceptual
explanantion should be enough for everyday usage.
\begin{landscape}
...
\multicolumn{1}{|m{1.2in}|}{Appropriateness of the system and}
 & Acquirer
 & Will this project develop the students software engineering skills required to work in industry?
 ...
 & User
 & Will this be user friendly enough so a computer illiterate person can use it?
 & Provide visual and textual cues to make it easy for non technical people to use
\\\hline
...
Feasibility of constructing, testing, }
 ...
 & Encourage members to work on parts of the project they are interested in, and share the workload.
\\\hhline{~---}
verifying and deploying the
system and software.
 & Tester
 & Will the testing utilities be user-friendly enough to learn without spending too much time?
 & Collectively identify appropriate testing utilities for each platform the testers may be using, and identify helpful tutorials
\\\hline
Risks of constructing, deploying, and
 & Aquirer
 & Will this system make the University of Idaho legally liable if the system is hacked?
 & Educate users of the risks of posting private information on the Internet, limit what information GUS tracks
\\\hhline{~---}
...
Concerns with respect to the maintainability and
 ...
 & Include Dr. Jefferey in every step of the design process, and try to make maintaining GUS worth someones while
\\\hhline{~---}
\multicolumn{1}{|m{1.2in}|}{evolvability of the system and software.}
 ...
 & Keep all aspects of GUS extremely simple
\\\hline
\end{supertabular}
\end{flushleft}
\end{landscape}
...
The graphical user interfaces take input from users and deliver output for the web-interface to take to the database,
it also takes input from the database and displays it to the users.
The web-interfaces take the input from the GUIs and ensures the data is valid and safe to put in the database,
or it takes information from that database, and ensures it goes to the appropriate users.

\subsection{Developers Architecural View}


\subsection{Users Architectural View}
GUS is a website with different roles for users, officers, and administrators,
by logging into GUS a user will have member access to groups that she is a member of
officer access to groups she is an officer for, and administrative privileges for
groups she administrates.

\subsubsection{Users View Identification}
The purpose of the users view is to enable users to connect with groups, and groups to track members.
The major components of this architecture are: a user module, an officer module, an administrative module, and a forums module.
...
\subparagraph{}User-view class diagram which this entry is based on was designed by Brett Hitchcock,
this entry was written by Cynthia Rempel.

\subparagraph{}The purpose of the email module is to enable users to send emails to groups and other users.
...
\subparagraph{}{A user can access her email and text features through her email page,
she can only text people (or groups) that have given her permission to.}\\
\pagebreak

\paragraph{Forums Module}
\begin{wrapfigure}{l}{280px}
  \begin{center}
...
\subparagraph{} Filling up space to frame the picture nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn
nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn
nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn.nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn
nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn. {nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn.}\\
...
\subparagraph{} Filling up space to frame the picture nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn
nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn
nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn.nnnnn nnnnnnnnnn nnnnn nnnnn nnnnn nnnnn nnnnn
nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn. { nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn nnnnn.}\\

\begin{wrapfigure}{r}{300px}
  \begin{center}
\includegraphics{../pdf_png/officer_use_cases.png}
  \end{center}
\end{wrapfigure}
...
\textbf{Actor:} officer \\
\textbf{Goal:} expense information is recorded into gus \\
...
4. Choose the users who need to be reminded (perhaps GUS could be used to store who has paid dues and ) \\
\textbf{Alternatives:} \\
...
%% row 1
GUS is made of three basic systems, the user interface (forms class),
...
&
\includegraphics[width=240px,height=243px]{../pdf_png/php_class.png}
\end{tabular}
